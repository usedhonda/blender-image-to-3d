...
10. Finish with editable `.blend`, requested exchange format, source/assumption record, and renders. Re-import the export and render again. Report only checks actually performed, plus source limits and known defects.
